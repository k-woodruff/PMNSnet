...
class Net(nn.Module):
    def __init__(self, input_size=50, latent_size=3, encoder_num_units=[500, 100],
        ...
        self.decode_latent = nn.Linear(self.latent_size, self.decoder_num_units[0])
